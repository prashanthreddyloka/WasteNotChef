...
export function ReceiptUpload({ onItemsAdded }: { onItemsAdded: (items: PantryItem[]) => void }) {
  ...
  return (
    <section className="rounded-[1.8rem] border border-teal-100 bg-white/85 p-6 shadow-float" aria-busy={busy}>
      ...
      <p className="mt-2 text-sm text-slate-500">JPEG, PNG, or WebP · Up to 10 MB. Keep item names and prices in view. Unrecognized abbreviations may be skipped; check your list after scanning.</p>
